//Online Exam - task 4 - Oasis infobyte 
...
class TestBegin extends JFrame implements ActionListener  
{
    ...
    {   
        ...
        if(current==0)  
        {  
            l.setText("1: Which one of the following is not a Java feature?");  
            jb[0].setText("Object-oriented");jb[1].setText("Use of pointers");jb[2].setText("Portable");jb[3].setText("Dynamic and Extensible");   
        }  
        if(current==1)  
        {  
            l.setText("2:Which of these packages contains the exception Stack Overflow in Java?");  
            jb[0].setText(" java.io");jb[1].setText("java.system");jb[2].setText("java.lang");jb[3].setText("java.util");  
        }  
        if(current==2)  
        {  
            l.setText("3: Which of the following is a type of polymorphism in Java Programming?");  
        ...
        if(current==3)  
        {  
            l.setText("4:  Which of the following is not an OOPS concept in Java?");  
            jb[0].setText("Polymorphism");jb[1].setText("Inheritance");jb[2].setText("Compilation");jb[3].setText("Encapsulation");  
        }  
        if(current==4)  
        {  
            l.setText("5: What is the extension of java code files?");  
